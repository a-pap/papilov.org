...
Средние CPM для баннерной рекламы (SSP-сторона, 2024): США — $1.43, UK — $1.05, Германия — $0.90, Франция — $0.80, Бразилия — $0.50, Индия — $0.25. Разброс 8× между верхом и низом определяет экономику монетизации.
...
**Интерактивная версия** этого материала с визуализациями и анимированными графиками: [полный инфографик](/research/prebid-js-explainer/infographic.html).
